...
pval_mom = read.table("~/Desktop/MoBa_QCed_5530/analysis_151217/moms_gxe_pvals", h=T)
...
renderPlot({
        ...
        if(input$select_genomes == "Maternal"){
                source_file = paste("~/Desktop/MoBa_QCed_5530/analysis_151217/moms_", ss, "_stageii.raw", sep="")
        } else {
